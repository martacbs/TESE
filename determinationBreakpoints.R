...
setwd("/Users/martasantos/Desktop/breaksGenerated/logNormal/hotel50breaks")
getwd()
#somePDFPath = "/Users/martasantos/Desktop/NewData/logLogistic/50porCentoNewData/graphsHotel/lolLogisticHotelBreaks50porcentGraphsDBEST.pdf"
...
View(test)
write.csv2(test,  "logNormalhotel50breaksPointsDetected.csv")
